...
class RamlJsonEnhancer {
  ...
  enhaceJson(ramlObj, rootTypes, opts) {
    ...
    ramlObj.resources.forEach((resource) => {
      ...
      resource.allUriParameters = ramlObj.baseUriParameters ? this._clone(ramlObj.baseUriParameters) : [];
      ...
      if (resource.baseUriParameters) {
        ...
        resource.allUriParameters = this._mergeBaseParameters(resource.allUriParameters, resource.baseUriParameters);
      }
      ...
      optsCopy.parentUrl = fullUrl;
      optsCopy.allUriParameters = resource.allUriParameters ? this._clone(resource.allUriParameters) : [];
